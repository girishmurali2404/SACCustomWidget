	...
	class Box extends HTMLElement {
		...
		render(val01, val02, val03, info, color) {
			...
			if(rounded01 >=0 && rounded01 <=100) {
				...
				this.$svg.innerHTML = '<path d="M600 100 L525 200 L675 200 Z" style="fill=' + color + ';"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="150" y="90" font-size="50" font-weight="bold">' + rounded01 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"<path d="M525 200 L450 300 L750 300 L675 200 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="150" y="200" font-size="50" font-weight="bold">' + rounded02 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"<path d="M450 300 L375 400 L825 400 L750 300 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="150" y="300" font-size="50" font-weight="bold">' + rounded03 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
}
		}
