(function() { 
	...
	class Box extends HTMLElement {
		...
		render(val01, val02, val03, val04, val05) {
			...
			if(rounded01 >=0 && rounded01 <=100) {
				...
				this.$svg.innerHTML = '<path d="M600 100 L525 200 L675 200 Z" style= "fill :' + color + ';"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="600" y="175" font-size="50" font-weight="bold">' + rounded01 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="800" y="150" font-size="45" font-weight="normal">' + info + '</text>"<path d="M525 200 L450 300 L750 300 L675 200 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="600" y="250" font-size="50" font-weight="bold">' + rounded02 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="950" y="250" font-size="45" font-weight="normal">' + info + '</text>"<path d="M450 300 L375 400 L825 400 L750 300 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="600" y="350" font-size="50" font-weight="bold">' + rounded03 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="1000" y="350" font-size="45" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"<path d="M375 400 L300 500 L900 500 L825 400 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="600" y="450" font-size="50" font-weight="bold">' + rounded03 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="1100" y="450" font-size="45" font-weight="normal">' + info + '</text>"<path d="M300 500 L225 600 L975 600 L900 500 Z"></path><text class="percentage" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="600" y="550" font-size="50" font-weight="bold">' + rounded03 + '</text><text class="title" text-anchor="middle" fill=' + color + ' alignment-baseline="middle" x="1100" y="550" font-size="45" font-weight="normal">' + info + '</text>"';
			}
		}
	...
	customElements.define("com-demo-pyramid", Box);
})();
