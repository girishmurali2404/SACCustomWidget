	...
	class Box extends HTMLElement {
		...
		render(val01, val02, val03, info, color) {
			...
			if(rounded01 >=0 && rounded01 <=100) {
				...
				this.$svg.innerHTML = '<path d="M150 0 L75 150 L225 150 Z" style="fill:yellow;"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="150" y="90" font-size="50" font-weight="bold">' + rounded01 + '</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"<path d="M75 150 L50 250 L250 250 L225 150 Z"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="150" y="200" font-size="50" font-weight="bold">' + rounded02 + '</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"<path d="M50 250 L25 350 L275 350 L250 250 Z"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="150" y="300" font-size="50" font-weight="bold">' + rounded03 + '</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
}
		}
