	...
	class Box extends HTMLElement {
		...
		render(val, info, color) {
			...
			if(rounded >=0 && rounded <=100) {
				...
				this.$svg.innerHTML = '<path d="M150 0 L75 100 L225 100 Z"></path><text class="percentage" text-anchor="middle" alignment-baseline="middle" x="150" y="60" font-size="50" font-weight="bold">' + rounded + '%</text><text class="title" text-anchor="middle" alignment-baseline="middle" x="500" y="450" font-size="90" font-weight="normal">' + info + '</text><path d="' + x + '" class="data-arc"></path>"';
				}
		}
